...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('settextdetectionthreshold')
    .setDescription('Set the threshold for AI text detection')
  ...
  async execute(interaction) {
    ...
    await db.query(
      'INSERT INTO text_detection_thresholds (guild_id, name, value) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE value=?',
